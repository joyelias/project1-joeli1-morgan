...
def index(): 
    ...
    return flask.render_template("index.html", recipe_title = recipe_title, recipe_image=recipe_image, serving_size= serving_size, tweets_about_burgers= tweets_about_burgers)
